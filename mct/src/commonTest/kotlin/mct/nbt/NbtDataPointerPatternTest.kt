...
class NbtDataPointerPatternTest : FreeSpec({
    "BuiltinSet" {
        listOf(
            ...
            match(
                ">#>#block_entities>0>#SpawnPotentials>0>#data>#entity>#Passengers>0>#CustomName",
                "entities' Passengers tag"
            ),
            match(
                ">#>#block_entities>0>#SpawnPotentials>0>#data>#entity>#Passengers>0>#Passengers>0>#Passengers>0>#CustomName",
                "nested entities' Passengers tag"
            ),
